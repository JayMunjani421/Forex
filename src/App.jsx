      ...
      <div className="w-full max-w-6xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto px-4 relative z-10">
          <h1 className="text-3xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-blue-400 via-indigo-400 to-purple-400 tracking-tight drop-shadow-sm">
            {activeTab === 'profit' ? 'Real-Time Profit Calculator' : activeTab === 'lotsize' ? 'Lot Size Calculator' : activeTab === 'margin' ? 'Margin Calculator' : activeTab === 'swap' ? 'Swap Calculator' : 'Forex Calculators'}
          </h1>
        ...
        {/* Calculator Widget */}
        <div className="px-2 md:px-0 relative z-20 w-full mt-4">
          ...
          {activeTab !== 'profit' && activeTab !== 'lotsize' && activeTab !== 'margin' && activeTab !== 'swap' && (
