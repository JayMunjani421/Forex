...
const LotSizeCalculator = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto relative rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
      {/* Background with overflow-hidden for blobs */}
      <div className="absolute inset-0 bg-[#0d1323]/80 backdrop-blur-2xl rounded-3xl border border-white/5 overflow-hidden z-0 pointer-events-none">
